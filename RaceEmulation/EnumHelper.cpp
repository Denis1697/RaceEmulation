...
int  EnumHelper::START_X_OFFSET      = 44;
int  EnumHelper::START_Y_OFFSET      = 4;
int  EnumHelper::PARTS_COUNT         = 6;
int  EnumHelper::OBSTACLES_NO        = 3;
int  EnumHelper::CAR_HEAD_TOP        = 0;
int  EnumHelper::CAR_HEAD_BOTTOM     = 3;
int  EnumHelper::DECIMAL             = 10;
